...
import ReroutingCard from "../../components/tracking/ReroutingCard.jsx";
...
import TelemetrySimulatorModal from "../../components/tracking/TelemetrySimulatorModal.jsx";
      ...
      <div className="min-h-screen pb-8">
        ...
        <div className="px-4 py-4 sm:px-6 lg:pl-[328px] lg:pr-8 lg:pt-6">
          ...
          <main className="mt-6 space-y-6">
            ...
            {selectedShipment ? (
              <div className="flex flex-wrap items-center justify-between gap-3 rounded-xl border border-slate-200/80 bg-white/80 px-4 py-3 shadow-sm">
                <div className="text-sm text-slate-600">
                  Demo telemetry for{" "}
                  <span className="font-semibold text-slate-900">{selectedShipment.id}</span>
                </div>
                <button
                  type="button"
              ...
              <>
                ...
                <section className="grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
                  <div className="space-y-6">
                    ...
                    <ReroutingCard shipment={selectedShipment} />
                  </div>
