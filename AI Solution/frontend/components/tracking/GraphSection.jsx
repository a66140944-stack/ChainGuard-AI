...
export default function GraphSection({ shipment, latestShipmentData }) {
  ...
  useEffect(() => {
    ...
    const nextTemperature =
      latestShipmentData.temperature != null ? Number(latestShipmentData.temperature) : null;
    const nextRiskScore =
      latestShipmentData.riskScore != null
        ? Number(latestShipmentData.riskScore <= 1 ? latestShipmentData.riskScore * 100 : latestShipmentData.riskScore)
        : null;
